...
from app.core.dependencies import get_admin_user, get_db, get_employee_user, get_current_branch_id, resolve_branch_scope
...
def list_attendance(
    ...
    return attendance_service.list_records(db, attendance_date, scoped_branch_id)
